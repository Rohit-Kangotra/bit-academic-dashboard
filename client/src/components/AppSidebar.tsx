...
const navItems: NavItem[] = [
  ...
  { title: "My Mentees", url: "/faculty/mentees", icon: Users, roles: ["faculty"] },
  { title: "Courses", url: "/courses", icon: BookOpen, roles: ["student", "faculty"] },
  { title: "Skills", url: "/skills", icon: TrendingUp, roles: ["student"] },
  { title: "Activity Hub", url: "/activities", icon: Star, roles: ["student", "admin"] },
  { title: "Assignments", url: "/assignments", icon: ClipboardList, roles: ["student"] },
  { title: "Projects", url: "/projects", icon: FolderKanban, roles: ["student"] },
  { title: "Placements", url: "/placements", icon: Briefcase, roles: ["student", "admin"] },
  { title: "Leave Requests", url: "/leaves", icon: CalendarOff, roles: ["student", "faculty"] },
  { title: "Class View", url: "/class-view", icon: Users, roles: ["admin"] },
